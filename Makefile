#############################################################################
# Makefile for building: raspberrytomb
# Generated by qmake (2.01a) (Qt 4.7.2) on: Sat Mar 10 19:51:09 2012
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/raspberrytomb1.0.0 || $(MKDIR) .tmp/raspberrytomb1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/raspberrytomb1.0.0/ && $(COPY_FILE) --parents src/beaglemain.h src/sync.h src/songObj.h src/readDB.h src/qmpyuvreader.h src/qmpwidget.h src/preferences.h src/prefdialog.h src/mysqlconn.h src/mplaycon.h src/about.h src/newplaylist.h src/playlistobj.h src/sync.h src/songObj.h src/readDB.h src/qmpyuvreader.h src/qmpwidget.h src/preferences.h src/prefdialog.h src/playlistobj.h src/newplaylist.h src/mysqlconn.h src/mplaycon.h src/beaglemain.h src/about.h src/openplaylist.h src/radioObj.h .tmp/raspberrytomb1.0.0/ && $(COPY_FILE) --parents images/BTres.qrc .tmp/raspberrytomb1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/beaglemain.cpp src/sync.cpp src/songObj.cpp src/readDB.cpp src/qmpwidget.cpp src/preferences.cpp src/prefdialog.cpp src/mysqlconn.cpp src/mplaycon.cpp src/about.cpp src/newplaylist.cpp src/playlistobj.cpp src/openplaylist.cpp src/radioObj.cpp .tmp/raspberrytomb1.0.0/ && $(COPY_FILE) --parents src/prefdialog.ui src/about.ui src/newplaylist.ui src/beaglemain.ui src/openplaylist.ui .tmp/raspberrytomb1.0.0/ && (cd `dirname .tmp/raspberrytomb1.0.0` && $(TAR) raspberrytomb1.0.0.tar raspberrytomb1.0.0 && $(COMPRESS) raspberrytomb1.0.0.tar) && $(MOVE) `dirname .tmp/raspberrytomb1.0.0`/raspberrytomb1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/raspberrytomb1.0.0
